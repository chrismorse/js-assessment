...
describe('best practices', function(){
  ...
  it('you should use parseInt correctly', function() {
    expect(bestPracticesAnswers.parseInt('12', 10)).to.eql(12);
    //expect(bestPracticesAnswers.parseInt('12px', 10)).to.eql(12);
    //expect(bestPracticesAnswers.parseInt('0x12', 16)).to.eql(0);
  });
